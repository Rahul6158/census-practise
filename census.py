...
if uploaded_file is not None:
    ...
    if st.checkbox("Histogram for showing the Age Groups"):
        ...
        ax.hist(data['Age_Group_0_29'], bins=10,color='skyblue',title='age 0-29')
        ax.hist(data['Age_Group_30_49'], bins=10,color='blue',title='age 30-49')
        ax.hist(data['Age_Group_50'], bins=10,color='indigo',title='age 50>')
