...
if uploaded_file is not None:
    ...
    if st.checkbox("Histogram for showing the Age Groups"):
        ...
        ax.hist(data['Age_Group_0_29'], bins=50,color='skyblue',label='Age 0-29',alpha=0.5,edgecolor='black')
        ax.hist(data['Age_Group_30_49'], bins=50,color='royalblue',label='Age 30-49',alpha=0.5,edgecolor='black')
        ax.hist(data['Age_Group_50'], bins=50,color='blue',label='Age 50',alpha=0.5,edgecolor='black')
