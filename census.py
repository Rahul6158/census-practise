...
if uploaded_file is not None:
    ...
    if st.checkbox("Histogram for showing the Age Groups"):
        ...
        ax.hist(data['Age_Group_0_29'],labels='Age 0-29',edgecolor='black')
        ax.hist(data['Age_Group_30_49'],label='Age 30-49',edgecolor='black')
        ax.hist(data['Age_Group_50'], bins=10,label='Age 50',edgecolor='black')
