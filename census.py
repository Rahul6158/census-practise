...
if uploaded_file is not None:
    ...
    if st.checkbox("Histogram for showing the Age Groups"):
        ...
        ax.hist(data['Age_Group_0_29'], bins=10,label='Age 0-29',color ='trueblue',edgecolor='black')
        ax.hist(data['Age_Group_30_49'], bins=10,label='Age 30-49',color ='royalblue',edgecolor='black')
